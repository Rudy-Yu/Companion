...
const PlayfulTextarea = forwardRef(({
  label,
  error,
  helperText,
  icon,
  ...
  // Base styles
  const baseStyles = 'block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors duration-200 resize-none'
...
export default PlayfulTextarea 
...
const PlayfulRadio = forwardRef(({
  ...
  // Base styles
  const baseStyles = 'h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500 transition-colors duration-200'
...
PlayfulRadio.displayName = 'PlayfulRadio'
